...
- (void)setupFloatLabel
{
    ...
    if (height == 568)
        _floatLabel.font =[UIFont boldSystemFontOfSize:10.0f];
    else if (height == 667) // iphone6 and smaller
        _floatLabel.font =[UIFont boldSystemFontOfSize:12.0f];
    else if (height == 736 || height == 812) // iphoneX and iphone7+s
        _floatLabel.font =[UIFont boldSystemFontOfSize:14.0f];
    else if (height == 896) // iphone Xs and XR
        _floatLabel.font =[UIFont boldSystemFontOfSize:15.0f];
    else
        _floatLabel.font =[UIFont boldSystemFontOfSize:14.0f];
    ...
    _floatLabelActiveColor = [UIColor blackColor];
    
    // animationDuration
    _floatLabelShowAnimationDuration = @0.25f;
    _floatLabelHideAnimationDuration = @0.15f;
}
...
{
    CGFloat top = [self.text length] ? 8.0f : 0.0f;
